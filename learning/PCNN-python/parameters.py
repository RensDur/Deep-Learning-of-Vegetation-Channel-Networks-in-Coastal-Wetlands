...
def params():
    ...
    parser.add_argument('--loss_h', default=0, type=float, help='Weight of loss factor theta_0')
    ...
    parser.add_argument('--loss_reg', default=10, type=float, help='Weight of regularizers in loss')
    ...
    parser.add_argument('--separation', default=1, type=float, help='cell separation in meters')
