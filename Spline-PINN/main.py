...
def main():
    ...
    # Create dataset
    data = dataset.Dataset(params, torch_device, types=["topoflat"], water_strategies=["Hin"], vegetation_ics=["vd-vijsel"], orientations=["east"])
    ...
    window = PerformanceSummaryWindow(params.width * params.resolution_factor, params.height * params.resolution_factor, 10, 100)
