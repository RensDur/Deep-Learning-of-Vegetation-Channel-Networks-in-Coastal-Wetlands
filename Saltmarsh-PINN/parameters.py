...
def params():
	...
	parser.add_argument('--n_samples', default=10000, type=int, help='number of freespace samples (unordered set) per environment in the batch (default: 1000)')
	parser.add_argument('--n_reg_interval_samples', default=10, type=int, help='number of samples (different offsets) per batch (default: 10)')
