...
def params():
	...
	parser.add_argument('--loss_vegetation', default=1, type=float, help='loss factor for vegetation stem density loss')
	...
	parser.add_argument('--hidden_size', default=46, type=int, help='hidden size of network (default: 20)')
