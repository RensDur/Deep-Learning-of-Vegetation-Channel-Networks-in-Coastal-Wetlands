...
def params():
	...
	# Network parameters
	parser.add_argument('--net', default="ShallowWaterModelCNN", type=str, help='network to train', choices=["Shortcut","Shortcut2","Shortcut2_residual","Shortcut4","Shortcut4_residual","Shortcut3","Fluid_model","Wave_model"])
