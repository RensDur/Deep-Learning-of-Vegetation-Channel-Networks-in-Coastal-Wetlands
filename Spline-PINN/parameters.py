...
def params():
	...
	parser.add_argument('--batch_size', default=30, type=int, help='batch size (default: 30)')
	...
	parser.add_argument('--hidden_size', default=75, type=int, help='hidden size of network (default: 20)')
