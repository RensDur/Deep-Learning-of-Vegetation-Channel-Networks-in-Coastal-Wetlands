...
def params():
	...
	parser.add_argument('--loss_sediment', default=1e6, type=float, help='loss factor for sedimentary bed elevation loss')
	parser.add_argument('--loss_vegetation', default=1e4, type=float, help='loss factor for vegetation stem density loss')
