...
def main():
    ...
    for ablation_start in range(0, 500, 100):
        for i in range(ablation_start, ablation_start+100, 10):
            torch.save(rescaled_evaluation_residuals[i:(i+10)], f"./ablation_study_evaluation/eval_residuals/ablation {ablation_start}-{ablation_start+100}/sfere_start {i} sfere_end {i+10}.pt")
